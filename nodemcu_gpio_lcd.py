...
class GpioLcd(LcdApi):
    ...
    def __init__(self, rs_pin=None, enable_pin=None, d0_pin=None, d1_pin=None,
        ...
        self.rs_pin = device.D2
        self.enable_pin = device.D1
        self.rw_pin = rw_pin
        ...
        if d4_pin and d5_pin and d6_pin and d7_pin:
            ...
            self.d2_pin = None
            self.d3_pin = None
            self.d4_pin = device.D8
            self.d5_pin = device.D7
            self.d6_pin = device.D4
            self.d7_pin = device.D3
